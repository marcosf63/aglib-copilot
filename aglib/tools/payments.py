...
class MockPaymentGateway:
    ...
    def process_payment(self, amount: float, currency: str, method_id: str, order_id: str) -> Dict:
        """Process a payment"""
    ...
    def refund_payment(self, transaction_id: str, amount: float, reason: str) -> Dict:
        ...
        original_transaction["refunded_amount"] = original_transaction.get("refunded_amount", 0) + amount
    ...
    def get_transaction_history(self, user_id: str, date_from: str = None, date_to: str = None) -> List[Dict]:
...
class ProcessPaymentTool(Tool):
    def __init__(self):
        super().__init__(
            ...
            description="Processar um pagamento"
        )
...
class CheckPaymentStatusTool(Tool):
    def __init__(self):
        super().__init__(
            ...
            description="Verificar status de um pagamento"
        )
    ...
    async def execute(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        try:
            transaction = mock_gateway.check_payment_status(parameters["transaction_id"])
...
class RefundPaymentTool(Tool):
    def __init__(self):
        super().__init__(
            name="refund_payment",
            description="Processar estorno de pagamento"
        )
...
class GetTransactionHistoryTool(Tool):
    def __init__(self):
        super().__init__(
            ...
            description="Buscar histórico de transações"
        )
