...
class MockSchedulingDB:
    ...
    def book_appointment(
        self, user_id: str, date: str, time: str, service: str, notes: str = ""
    ) -> Dict:
        """Book an appointment"""
...
class BookAppointmentTool(Tool):
    def __init__(self):
        super().__init__(name="book_appointment", description="Agendar um compromisso")
...
class CancelAppointmentTool(Tool):
    def __init__(self):
        super().__init__(
            name="cancel_appointment", description="Cancelar um agendamento"
        )
...
class RescheduleAppointmentTool(Tool):
    def __init__(self):
        super().__init__(
            name="reschedule_appointment", description="Reagendar um compromisso"
        )
...
class GetUserAppointmentsTool(Tool):
    def __init__(self):
        super().__init__(
            name="get_user_appointments", description="Buscar agendamentos do usuário"
        )
    ...
    async def execute(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        try:
            appointments = mock_db.get_user_appointments(
                user_id=parameters["user_id"], date_from=parameters.get("date_from")
            )
...
class ListServicesTool(Tool):
    def __init__(self):
        super().__init__(
            name="list_services", description="Listar serviços disponíveis"
        )
